...
get_template_part( 'includes/header' , 'page-title' ); ?>
		...
		<!-- BLOG AREA START -->
		<div class="banko-blog-area banko-blog-single single-blog-details">
				<div class="container">				
					<div class="row">
						...
						<?php if( have_posts() ) : ?>
							...
							<?php while( have_posts() ) : the_post(); ?>					
								...
								<?php $portdesc  = get_post_meta( get_the_ID(),'_banko_portdesc', true ); 
								$pgellaryu  = get_post_meta( get_the_ID(),'_banko_pgellaryu', true ); 
								...
								<div class="col-md-6">
									<div class="pimgs">
										<div class="single_gallery owl-carousel  curosel-style">										
											<?php
												banko_slider_o('_banko_pgellaryu','full');									
											?>																				
										</div>			
									</div>
								</div>
										...
										<div class="portfolio_details">
											<div class=" col-md-6  col-sm-12 col-xs-12 blog-lr">
												<div class="pimgs">
													...
													<?php the_post_thumbnail('banko-single-portfolio');?>
